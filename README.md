board: Example Using Multiple Java EE 7 Technologies Deployed as an EAR
==============================================================================================
Author: Pete Muir
Level: Intermediate
...
You should see messages similar to the following:
    ...
    INFO  [com.tsystems.javaschool.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [com.tsystems.javaschool.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
    ...
    INFO  [org.jboss.as.connector.subsystems.datasources] (MSC service thread 1-5) JBAS010409: Unbound data source [jboss/datasources/boardTestDS]
